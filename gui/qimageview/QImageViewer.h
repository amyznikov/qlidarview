...
#include <core/displayfunction/c_image_display_function.h>
...
public:
  ...
  void setDisplayFunction(c_image_display_function * displayfunc);
  c_image_display_function * displayFunction() const;
...
protected:
  ...
  QImage qimage_;
  c_image_display_function * display_function_ = Q_NULLPTR;
